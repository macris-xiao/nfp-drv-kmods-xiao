...
#define NFP_NET_TX_WORK		256	/* Max TX completion to handle */
...
struct nfp_net_r_vector {
	...
	int irq_idx;			/* Index to MSI-X/MSI_entries */
 ...
 */
static inline u8 nn_readb(u8 __iomem *base, int off)
{
