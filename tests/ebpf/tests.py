...
class NFPKmodBPF(NFPKmodAppGrp):
    ...
    def populate_tests(self):
        ...
        XDP = (('xdp_pass', XDPpass, 'XDP pass test'),
               ...
               ('xdp_shifts32', XDPshifts32,
                'XDP test of logic shift operations (ALU32)'),
               ('xdp_shifts32_ind', XDPshifts32_ind,
                'XDP test of logic indirect shift operations (ALU32)'),
               ('xdp_ashifts', XDPashifts,
                'XDP test of arithmetic right shift operations'),
               ('xdp_ashifts32', XDPashifts32,
                'XDP test of arithmetic right shift operations (ALU32)'),
               ('xdp_ashifts32_ind', XDPashifts32_ind,
                'XDP test of arithmetic indirect right shift operations (ALU32)'),
               ...
               ('xdp_alu_imm_opt', XDPalu_imm_opt, "Test ALU imm optimizations"),
               ('xdp_cmp', XDPcmp, "Test compare instructions"),
               ('xdp_cmp32', XDPcmp32, "Test compare instructions (jmp32)"),
