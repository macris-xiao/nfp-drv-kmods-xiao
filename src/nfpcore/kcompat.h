...
#define RHEL_RELEASE_LT(r, x, y, z)\
	(VER_RHEL_LT(r, 0) || (RHEL_MAJOR_EQ(r) && RHEL_RELEASE_EXTRACT < RHEL_RELEASE_MERGE(x, y, z)))
#define RHEL_RELEASE_GE(r, x, y, z)\
	(VER_RHEL_GE(r+1, 0) || (RHEL_MAJOR_EQ(r) && RHEL_RELEASE_EXTRACT >= RHEL_RELEASE_MERGE(x, y, z)))
