 ...
 */
static void nfp_nfd3_tx_complete(struct nfp_net_tx_ring *tx_ring, int budget)
{
 ...
 */
static void
nfp_nfd3_rx_csum(struct nfp_net_dp *dp, struct nfp_net_r_vector *r_vec,
...
#else
void nfp_nfd3_ctrl_poll(unsigned long arg)
#endif
{
#ifdef CONFIG_NFP_NET_PF
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 10, 0)
